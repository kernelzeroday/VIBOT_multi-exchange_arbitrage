...
#CURRENCIES = ["BTC", "XRP", "ETH", "DASH", "ZEC", "XLM", "STR", "LTC", "ETC", "XMR", "LSK", "GNT", "OMG", "XEM", "ZRX", "SC", "REP", "CVC", "FCT", "USDT"]
CURRENCIES = ["BTC", "XRP", "ETH", "DASH", "ZEC", "XLM", "STR", "USDT"]
SUBSCRIPTIONS = [("pbal2", 0), ("cbal2", 0), ("bbal2", 0)]
BITTREX = {}
CEX = {}
POLONIEX = {}
log_filename = "2018-08-15"
