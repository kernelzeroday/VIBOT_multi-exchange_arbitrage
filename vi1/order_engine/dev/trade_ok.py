...
#FIXME: get the order id
            ...
            if orderID:
                ...
                print("Okex Buy Order Warning: No orderID returned but API claims was successful!")
...
#FIXME: get order id
            ...
            if orderID:
                ...
                print("Okex Sell Order Warning: No orderID returned but API claims was successful!")
